 ...
 * Каждый полет это отдельная запись в таблице которая содержит следующее как минимимум
 * Выборка делается по датам и групируется по бортам, внутри группировки соритруется по дате
